...
PlayerDigEvent::PlayerDigEvent(Player& player, const glm::vec3& location): mPlayer(&player), mDigPosition(location)
{
}
...
void PlayerDigEvent::dig(World& world)
{
	...
	world.setBlock(mDigPosition.x, mDigPosition.y, mDigPosition.z, BlockId::Air);
}
